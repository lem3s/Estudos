...
public class Main {
  public static void main(String[] args) {
    JOptionPane.showMessageDialog(null, "Criando um objeto do tipo 'public Produto ()'");
    Produto produto1 = new Produto();

    JOptionPane.showMessageDialog(null, "Crie um objeto do tipo 'public Produto (String nomeDoProduto)'");
    String tempNome = JOptionPane.showInputDialog("Nome:");
    Produto produto2 = new Produto(tempNome);

    JOptionPane.showMessageDialog(null, "Crie um objeto do tipo 'public Produto (String nomeDoProduto, int quantidadeDoProduto)'");
    ...
    Produto produto3 = new Produto(tempNome, tempQuant);

    JOptionPane.showMessageDialog(null, "Crie um objeto do tipo 'public Produto (String nomeDoProduto, int quantidadeDoProduto, String tipoDoProduto, double valorDoProduto)'");
    tempNome = JOptionPane.showInputDialog("Nome:");
    ...
    Produto produto4 = new Produto(tempNome, tempQuant, tempTipo, tempValor);
